...
#p_DA_scen_two_price = repeat([52.50 7.50 7.50 121.50 9 48 28.50 18 0 49.50 10.50 31.50 150 93 31.50 6 31.50 0 13.50 16.50 51.00 0 16.50 12],n2, 1)
...
#p_DA_scen_two_price = repeat([52.5 7.5 7.5 150.0 9.0 60.0 51.00000000000001 18.0 0.0 49.5 10.500000000000002 31.5 150.0 150.0 31.5 6.0 16.5 0.0 13.5 16.5 51.00000000000001 0.0 16.5 12.0],n2, 1)
#p_DA = [52.5 7.5 7.5 150.0 9.0 60.0 51.00000000000001 18.0 0.0 49.5 10.500000000000002 31.5 150.0 150.0 31.5 6.0 16.5 0.0 13.5 16.5 51.00000000000001 0.0 16.5 12.0]

# for random.seed(1234) but n=50
p_DA_scen_two_price = repeat([48.0 7.5 7.5 150.0 9.0 48.0 51.00000000000001 18.0 0.0 49.5 10.500000000000002 34.5 150.0 150.0 31.5 6.0 31.5 0.0 13.5 16.5 51.00000000000001 0.0 12.0 12.0],n2, 1)
p_DA = [48.0 7.5 7.5 150.0 9.0 48.0 51.00000000000001 18.0 0.0 49.5 10.500000000000002 34.5 150.0 150.0 31.5 6.0 31.5 0.0 13.5 16.5 51.00000000000001 0.0 12.0 12.0]

# for random.seed(5678), n=200
#p_DA = [48.0 7.5 7.5 150.0 9.0 48.0 51.00000000000001 18.0 0.0 51.00000000000001 13.5 28.5 150.0 150.0 34.5 13.5 16.5 0.0 16.5 16.5 58.5 0.0 12.0 12.0]
#p_DA_scen_two_price = repeat([48.0 7.5 7.5 150.0 9.0 48.0 51.00000000000001 18.0 0.0 51.00000000000001 13.5 28.5 150.0 150.0 34.5 13.5 16.5 0.0 16.5 16.5 58.5 0.0 12.0 12.0],n2, 1)
...
delta_up= zeros(n2,24)
delta_down= zeros(n2,24)
...
if(isfile("A2_results_step1.6_twoprice.xlsx"))
    rm("A2_results_step1.6_twoprice.xlsx")
end

XLSX.writetable("A2_results_step1.6_twoprice.xlsx",
